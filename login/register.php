	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="registerCheck.php" method="post">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Reenter password">
						<input class="input100" type="password" name="pass" placeholder="Reenter Password">
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
					</div>
					...
					<div class="text-center p-t-10">
						<a class="txt1" href="/a3j/login/login.php">
							LOGIN
						</a>
					</div>
				</form>
