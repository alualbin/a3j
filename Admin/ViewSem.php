...
$vsubclass="class='active'";
 ...
 {
   $dept=$_GET["did"];
   $sql="delete from semester  where sem_id='$dept' ";
    ...
    <div class="row">
                        ...
                        <th>Delete</th>
                          	...
                          	<tr>
                          		...
                          		<td> <a class="btn  btn-blue" href='<?php echo "EditSem.php?eid=",$c; ?>' >Edit</a></td>
                              <td><a  class="btn  btn-danger confirmation" href='<?php echo "ViewSem.php?did=",$c; ?>'>Delete</a> </td>
