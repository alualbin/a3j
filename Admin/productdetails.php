    ...
    <div class="row">
    							...
    							<div class="panel panel-default">
    								<div class="panel-heading">
    									...
    									<div class="panel-tools">
    										...
    										<a class="btn btn-xs btn-link panel-refresh" href="productdetails.php">
                        ...
                        <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
    										...
    										<div class="form-group">
    											...
    											<div class="col-sm-5">
    											<input type="text" placeholder="Enter Product"  id="txt_Category" maxlength="100"   name="txt_Category" Required class="form-control">
    											</div>
    										</div>
                        ...
                        <div class="form-group">
                        <label class="col-sm-2 control-label" for="form-field-1">
                      Upload Product Image1 <span class="symbol required"></span>
                       </label>
...
if(isset($_POST["add"]))
{
 ...
 $pro=$conn->real_escape_string($_POST["txt_Category"]);
...
$sql="insert into product (Cat_Name,Cat_pic1)values('$pro','$filepath')";
echo $sql;
