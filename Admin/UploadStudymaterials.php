    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="page-header">
          <h1>Add Study Materials<small></small></h1>
        </div>
...
?>
						...
						<div class="form-group">
                          <label class="col-sm-2 control-label" for="form-field-1">
                             Upload Study Materials: <span class="symbol required"></span>
                          </label>
                          <div class="col-sm-5">
...
/*unlink($filepath1);*/
$sql="insert into studymaterials( course_id, year_id,sem_id,studymaterials) values ('$Course_id','$year_id','$sem_id','$filepath1')";
echo $sql;
