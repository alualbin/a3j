...
<div class="main-content">
  ...
  <div class="container">
    ...
    <div class="row">
                        ...
                        <div class="form-group">
                          <label class="col-sm-2 control-label" for="form-field-1">
                            Offer  <span class="symbol required"></span>
                          </label>
                          <div class="col-sm-5">
                          <input type="text" placeholder="Enter Offer" value="<?php echo $offer; ?>" id="txt_offer" pattern="[0-9]+" maxlength="2" title="please enter number only"  name="txt_offer" Required class="form-control">
                          </div>
                        </div>
  ...
  <div class="form-group">
                      <label class="col-sm-2 control-label" for="form-field-1">
                      Upload Category Image2 <span class="symbol required"></span>
                      </label>
                      <div class="fileupload fileupload-new col-sm-4" data-provides="fileupload">
                      <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?php echo $path2; ?>" alt=""/>
                      </div>
                      <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                      <div>
                        <span class="btn btn-light-grey btn-file"><span class="fileupload-new"><i class="fa fa-picture-o"></i> Select image</span><span class="fileupload-exists"><i class="fa fa-picture-o"></i> Change</span>
                          <input type="file"  name="file_image2">
                        </span>
                        <a href="#" class="btn fileupload-exists btn-light-grey" data-dismiss="fileupload">
                          <i class="fa fa-times"></i> Remove
                        </a>
...
$sql="update category set Cat_Name='$cat' ,Offer='$offer' where cat_id='$catid'";
}
else if ($_FILES['file_image1']['name'] != "" && $_FILES['file_image2']['name']=="" ) {
  $sql="update category set Cat_Name='$cat' ,Offer='$offer', Cat_pic1='$filepath' where cat_id='$catid'";
}
else if ($_FILES['file_image1']['name'] != "" && $_FILES['file_image2']['name']!="" ) {
  $sql="update category set Cat_Name='$cat' ,Offer='$offer', Cat_pic1='$filepath',Cat_pic2='$filepath1' where cat_id='$catid'";
}
echo $sql;
