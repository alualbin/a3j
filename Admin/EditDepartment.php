    ...
    <div class="row">
                        ...
                        <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
    										...
    										<div class="form-group">
    											...
    											<div class="col-sm-5">
    											<input type="text" placeholder="Enter Category" value="<?php echo $deptname; ?>" id="txt_department"  name="txt_department" Required class="form-control">
    											</div>
    										</div>
                        <div class="form-group">
                          <label class="col-sm-2 control-label" for="form-field-1">
                          ...
                          <div class="col-sm-5">
                          <input type="text" placeholder="Enter Offer" value="<?php echo $deptdesc; ?>" id="txt_desc"    name="txt_desc" Required class="form-control">
                          </div>
                        </div>
...
$sql="update  department set dept_name='$dept_name',dept_desc='$dept_desc' where dept_id='$dept'";
echo $sql;
...
echo "<script type='text/javascript'> swal({
   ...
   .then(() => {
       location.href='ViewDepartment.php';
   })</script>";
}
else {
