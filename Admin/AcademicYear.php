    ...
    <div class="row">
               ...
               <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-5">
                          <input type="text" placeholder="Enter  Year"  id="txt_year" name="txt_year" Required class="form-control">
                          </div>
...
if(isset($_POST["add"]))
{
 ...
 $txt_year=$conn->real_escape_string($_POST["txt_year"]);
 




$sql="insert into  academic_year(year)values('$txt_year')";
echo $sql;
