    ...
    <div class="row">
                        ...
                        <div class="form-group">
                          <label class="col-sm-2 control-label" for="form-field-1">
                            Labour Name <span class="symbol required"></span>
                          </label>
                          <div class="col-sm-5">
                          <input type="text" placeholder="Enter Labour Name" pattern="[A-Za-z]" title="please enter alphabetics only"  id="txt Labour" maxlength="100"   name="txt Labour" Required class="form-control">
                          </div>
                        </div>
                         ...
                         <div class="form-group">
                          <label class="col-sm-2 control-label" for="form-field-1">
                           Labour Address <span class="symbol required"></span>
                          </label>
                          <div class="col-sm-5">
                          <input type="text" placeholder="Enter Labour Address" pattern="[A-Za-z0-9]" title="please enter alphabetics only"  id="txt Labour" maxlength="100"   name="txt Labour" Required class="form-control">
                          </div>
                        </div>                     

                         <div class="form-group">
                          <label class="col-sm-2 control-label" for="form-field-1">
                          Labour Mobile Number <span class="symbol required"></span>
                          </label>
                          <div class="col-sm-5">
                          <input type="text" placeholder="Enter Labour Address" pattern="[A-Za-z0-9]" title="please enter alphabetics only"  id="txt Labour" maxlength="100"   name="txt Labour" Required class="form-control">
                          </div>
