...
$vsubclass="class='active'";
 ...
 {
   $year=$_GET["did"];
   $sql="delete from academic_year  where year_id='$year' ";
    ...
    <div class="row">
                        ...
                        <th>Delete</th>
                          	...
                          	<tr>
                          		...
                          		<td> <a class="btn  btn-blue" href='<?php echo "EditAcademicyear.php?eid=",$c; ?>' >Edit</a></td>
                              <td><a  class="btn  btn-danger confirmation" href='<?php echo "ViewAcademicyear.php?did=",$c; ?>'>Delete</a> </td>
