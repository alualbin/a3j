    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="page-header">
          <h1>Add Department<small></small></h1>
        </div>
    ...
    <div class="row">
               ...
               <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-5">
                          <input type="text" placeholder="Enter  name"  id="name" name="dept_name" Required class="form-control">
                          </div>

                        </div>
                        <div class="form-group">
                          <label class="col-sm-2 control-label" for="form-field-1">
                             Dpartment Description: <span class="symbol required"></span>
                          </label>
                          <div class="col-sm-5">
                          <input type="text" placeholder="Enter  description"  id="desc"name="dept_desc" Required class="form-control">
                          </div>
...
if(isset($_POST["add"]))
{
 ...
 $dept_desc=$conn->real_escape_string($_POST["dept_desc"]);





$sql="insert into  department(dept_name,dept_desc)values('$dept_name','$dept_desc')";
echo $sql;
